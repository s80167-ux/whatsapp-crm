    ...
    <div className="glass-panel w-full max-w-md p-8">
      ...
      <div className="space-y-4">
        {!passwordRecoveryActive ? (
          <label className="block">
            ...
            <div>
              ...
              />
              {mode === "register" && (
                <div className="flex flex-row items-center mt-1 ml-0">
                  <button
                    aria-label="Request another verification email"
                    className="icon-hover-trigger flex h-7 w-7 items-center justify-center rounded-full border border-whatsapp-line bg-white text-whatsapp-muted transition hover:border-whatsapp-dark hover:text-whatsapp-deep disabled:cursor-not-allowed disabled:opacity-60"
                  ...
                  <span className="ml-1 text-xs font-normal text-gray-500 whitespace-nowrap">{verificationResendLoading ? "Sending..." : "Resend"}</span>
                </div>
              )}
            </div>
          </label>
        ...
        <label className="block">
          ...
          <div>
            <div className="flex flex-row items-center gap-1 rounded-lg border border-whatsapp-line bg-white transition focus-within:border-whatsapp-dark focus-within:ring-2 focus-within:ring-whatsapp-green/15">
              <input
                className="auth-input-field flex-1 min-w-0 rounded-lg border-0 bg-transparent px-3 py-2 text-sm text-ink outline-none placeholder:text-whatsapp-muted"
              ...
              <button
                type="button"
                className="icon-hover-trigger flex h-5 w-5 items-center justify-center text-whatsapp-muted transition-colors hover:text-whatsapp-deep"
              ...
              >
                ...
                <span className="block text-[10px] font-normal text-gray-500 sm:hidden">{showPassword ? "Hide" : "Show"}</span>
                <span className="icon-hover-label hidden sm:inline">{showPassword ? "Hide password" : "Show password"}</span>
              </button>
            </div>
            {mode === "login" && !passwordRecoveryActive && (
              <div className="flex flex-row items-center mt-1 ml-0">
                ...
                <span className="ml-1 text-xs font-normal text-gray-500 whitespace-nowrap">{passwordResetRequestLoading ? "Sending..." : "Reset password"}</span>
              </div>
            )}
          </div>
        </label>
