                          ...
                          <div className="mt-2 mb-4 flex items-center gap-2">
                            ...
                            {isMobileDevice() && contact.phone && (
                              ...
                              >
                                <svg width="24" height="24" fill="none" viewBox="0 0 24 24" className="mb-1">
                                  <path
                                    d="M22 16.92v3a2 2 0 0 1-2.18 2A19.86 19.86 0 0 1 3.08 5.18 2 2 0 0 1 5 3h3a2 2 0 0 1 2 1.72c.13.81.36 1.6.68 2.34a2 2 0 0 1-.45 2.11l-1.27 1.27a16 16 0 0 0 6.29 6.29l1.27-1.27a2 2 0 0 1 2.11-.45c.74.32 1.53.55 2.34.68A2 2 0 0 1 22 16.92z"
                                    stroke="currentColor"
                                    strokeWidth="2"
                                    strokeLinecap="round"
                            ...
                            >
                              <svg width="24" height="24" fill="none" viewBox="0 0 24 24" className="mb-1">
                                ...
                                <path
                                  d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2m2 0v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6h16z"
                                  stroke="currentColor"
                                  strokeWidth="2"
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
